...
public abstract class EarthquakeMarker extends SimplePointMarker {
    ...
    private void drawCross(PGraphics pg, float x, float y) {
        ...
        pg.stroke(0);
        pg.fill(0);
        if ("Past Day".equalsIgnoreCase(age) || "Past Hour".equalsIgnoreCase(age)) {
            pg.line(x - r2, y - r2, x + r2, y + r2);
            pg.line(x - r2, y + r2, x + r2, y - r2);
        } else if ("Past Week".equalsIgnoreCase(age)) {
            pg.line(x, y - r2, x, y + r2);
            pg.line(x - r2, y, x + r2, y);
        }
    }
